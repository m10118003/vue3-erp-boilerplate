            ...
            <el-card>
                            ...
                            <template #footer>
                                <span class="payment-sign-dialog-footer flex justify-center">
                                    <el-button class="payment-sign-check mr-6" type="primary"
                                               @click="paymentSignDialog = false">
                                        確認
                                    </el-button>
                                    <el-button type="info" @click="paymentSignDialog = false">取消</el-button>
                                </span>
                            </template>
                        </el-dialog>
                        <!-- 操作, 送出請購單 -->
                ...
                <div class="payment-request-table-container">
                    ...
                    <el-table
                        ...
                        <!-- 請款欄位 簽收按鈕 -->
                        <el-table-column prop="payment_sign" label="請款" width="120">
                            <template #default="{ row }">
                                <el-button class="payment-sign-button" type="primary" @click="paymentSignDialog = true"
                                           @click.stop>{{
                                               row.payment_sign
                                           }}</el-button>
                            </template>
...
// 欄位中的請款, 簽收彈窗
const paymentSignDialog = ref(false);
